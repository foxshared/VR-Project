...
from quaternion import Quaternion1
...
class MadgwickAHRS:
    ...
    def update(self, gyroscope, accelerometer, magnetometer,samplePeriod = None):
        ...
        h = q * (Quaternion1(0, magnetometer[0], magnetometer[1], magnetometer[2]) * q.conj())
        ...
        gyroscopeQuat = Quaternion1(0, gyroscope[0], gyroscope[1], gyroscope[2])
        stepQuat = Quaternion1(step.T[0], step.T[1], step.T[2], step.T[3])
        ...
        self.quaternion = Quaternion1(q / norm(q))  # normalise quaternion
    ...
    def update_imu(self, gyroscope, accelerometer,samplePeriod = None):
        ...
        # Compute rate of change of quaternion
        qdot = (q * Quaternion1(0, gyroscope[0], gyroscope[1], gyroscope[2])) * 0.5 - self.beta * step.T
