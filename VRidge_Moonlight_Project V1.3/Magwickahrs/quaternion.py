...
class Quaternion1:
    ...
    def __init__(self, w_or_q, x=None, y=None, z=None):
        ...
        if x is not None and y is not None and z is not None:
            w = w_or_q
            q = np.array([w, x, y, z])
        elif isinstance(w_or_q, Quaternion1):
            q = np.array(w_or_q.q)
        else:
            q = np.array(w_or_q)
            if len(q) != 4:
    ...
    def conj(self):
        ...
        """
        return Quaternion1(self._q[0], -self._q[1], -self._q[2], -self._q[3])
    ...
    def from_angle_axis(rad, x, y, z):
        s = np.sin(rad / 2)
        return Quaternion1(np.cos(rad / 2), x*s, y*s, z*s)
    ...
    def __mul__(self, other):
        ...
        :return:
        """
        if isinstance(other, Quaternion1):
            ...
            return Quaternion1(w, x, y, z)
        elif isinstance(other, numbers.Number):
            q = self._q * other
            return Quaternion1(q)
    ...
    def __add__(self, other):
        ...
        :return:
        """
        if not isinstance(other, Quaternion1):
            if len(other) != 4:
